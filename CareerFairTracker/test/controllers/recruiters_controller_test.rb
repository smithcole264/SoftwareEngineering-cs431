...
class RecruitersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recruiter" do
    assert_difference('Recruiter.count') do
      post recruiters_url, params: { recruiter: { company_code: @recruiter.company_code, company_name: @recruiter.company_name, email: @recruiter.email, first_name: @recruiter.first_name, last_name: @recruiter.last_name, password: 'secret', password_confirmation: 'secret' } }
    end
  ...
  test "should update recruiter" do
    patch recruiter_url(@recruiter), params: { recruiter: { company_code: @recruiter.company_code, company_name: @recruiter.company_name, email: @recruiter.email, first_name: @recruiter.first_name, last_name: @recruiter.last_name, password: 'secret', password_confirmation: 'secret' } }
